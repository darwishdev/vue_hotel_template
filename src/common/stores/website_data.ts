...
const data: WebsiteData = {
    ...
    propertyDiscoverMore: {
        article: `<strong>Rhactus Hotels</strong> is making its mark in the hospitality industry, focusing on a blend of hotels and serviced apartments designed for today’s discerning traveler. Our journey began with <strong> Rhactus Hotel </strong> in New Alamein, our flagship property and the first of many. Known for its excellent business-friendly features and modern amenities, it offers the perfect environment for professionals and entrepreneurs on the go.
